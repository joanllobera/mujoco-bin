...
To integrate this package in your project, just add a link to in the manifest file. Make sure you point to the same MuJoCo plugin that the binaries. Current mujoco release being used is **3.5.0**

To add it, the file  `manifest.json`in the packages folder should have two lines that look like this: 

```
"org.mujoco": "https://github.com/deepmind/mujoco.git?path=unity#3.5.0",
"bin.mujoco": "https://github.com/joanllobera/mujoco-bin.git#3.5.0",
```
